...
<head>
	...
	<link rel="stylesheet" type="text/css" href="iniciosesion/css/columnas.css" />
					...
					<div class="columnatw">
						<center>
							...
							<div class="kalemp">
								...
								<img src="iniciosesion/imagenes/banco.svg" width="50px">

								<h4 style="font-size:25px;">
									<font color="#ffffff"><a href="index.php"><img src="iniciosesion/imagenes/flecha.svg" width="20px" style="vertical-align: middle;"></a><b>¿Eres Empresa?</b></font>
								</h4>

								<a href="#" class="este"><b>Continuar</b></a>
					...
					<div class="columnatw">
						<center>
							...
							<div class="kalperson">
								...
								<img src="iniciosesion/imagenes/user.svg" width="50px">

								<h4 style="font-size:25px;">
									<font color="#ffffff"><a href="index.php"><img src="iniciosesion/imagenes/flecha.svg" width="20px" style="vertical-align: middle;"></a><b>¿Eres Usuario?</b></font>
								</h4>

								<a href="iniciosesion/registro.php" class="este"><b>Continuar</b></a>
							</div>
						</center>
					</div>
			</form>
