...
<body bgcolor="#ffffff" style="color:#ffffff;font-family: sans-serif;">
	...
	$cod = substr(str_shuffle($permitted_chars), 0, 6);
	{
		$sql = "INSERT INTO usuarios(linea,estado,sitio,estatus,nombre_comple,apellidos,celular,codigo_email,usuario_nom,emailusuario,pasusuario,polit,empresa) 
	   VALUES ('$linea','$estado','$sitio','$estatus','$nombre_comple','$apellidos','$celular','$cod','$usuario_nom','$emailusuario','$pasusuario','$polit','$empresa')";
            ...
            <td class="py-5">
                ...
                <table class="email-body text-center">
                    <tbody>
						...
						<tr>
                            <td class="px-3 px-sm-5 pt-3 pt-sm-5 pb-3">
                                <h2 class="email-heading text-success">'.$cod.'
                                </h2>
                            </td>
                        </tr>
						<tr>
