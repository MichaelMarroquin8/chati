...
?>
	<form action="iniciar.php" method="POST" class="contenido">
	...
	<input type="hidden" id="tokenc" name="tokenc" value="e42s5AdZkznJ2JffECoR" />
	<input type="hidden" id="nombespac" name="nombespac" value="Soporte" />
