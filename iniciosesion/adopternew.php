		...
		<center>
			...
			<form action="iniciando.php" method="POST" class="contenido">
				...
				<div class="kal">
					...
					<h4>
						<font color="#130430">Iniciar en Chati</font>
					</h4>

					<input type="text" id="nombre_comple" name="nombre_comple" placeholder="Nombre Empresa" required autocomplete="off" />
					<br>
					<input type="password" id="pasusuario" name="pasusuario" placeholder="Contraseña" required autocomplete="off" />
					<br>
					<input type="text" id="celular" name="celular" placeholder="Nro. de celular" required autocomplete="off" />
					<br>
					<input type="text" id="usuario_nom" name="usuario_nom" placeholder="Email" required autocomplete="off" />
					<br>
					País:
					<select name="sitio" required style="border-radius:10px;">
						<option></option>
