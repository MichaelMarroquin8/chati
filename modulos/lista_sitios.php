...
$query = "SELECT * FROM sitios WHERE estatus='disponible' AND udetalle='$usur'
";

if($_POST['query'] != '')
{
  $query .= '
  AND pais LIKE "%'.str_replace(' ', '%', $_POST['query']).'%"
  ';
}

$query .= 'ORDER BY idsitio DESC ';
...
<td><?php echo "<a href='editar_sitio.php?idsitio=".$row['idsitio']."'><img src='imagenes/bor.svg' width='30px'></a>";?></td>								
<td><?php echo "<a href='eliminar/elim_sitio.php?idsitio=".$row['idsitio']."&estatus=".$nuevoestatus."&quieneli=".$usur."' id='txt_test' onclick='return ConfirmDelete()'><img src='imagenes/basura.svg' width='30px'></a>";?>
...
{ 
?>
<img src='imagenes/por.png' class="ga">
<?php
}
else{ 
?>
...
?>
									...
									<td><?php echo $row['nsitio']; ?></td>		
									<td><?php echo $row['zonahora']; ?></td>
