...
$resultado    = ("SELECT * FROM msjs WHERE tokeng='$tokenc' AND user_id='$clickUser' AND  to_id='$idConectado'  AND leido='NO' ");
...
if(mysqli_num_rows($re) >0){
    ...
    $leyendoMsj =("UPDATE msjs SET leido = 'SI' WHERE tokeng='$tokenc' AND user_id='$clickUser' AND to_id='$idConectado' ");
