...
$query = "SELECT * FROM titrabajo WHERE estatus='disponible'
";

if($_POST['query'] != '')
{
  $query .= '
  AND trabajo LIKE "%'.str_replace(' ', '%', $_POST['query']).'%"
  ';
}

$query .= 'ORDER BY idttr DESC ';
...
<td><?php echo "<a href='editar_ttrabajo.php?idttr=".$row['idttr']."'><img src='imagenes/bor.svg' width='30px'></a>";?></td>								
<td><?php echo "<a href='eliminar/elim_sitio.php?idttr=".$row['idttr']."&estatus=".$nuevoestatus."&quieneli=".$usur."' id='txt_test' onclick='return ConfirmDelete()'><img src='imagenes/basura.svg' width='30px'></a>";?>
