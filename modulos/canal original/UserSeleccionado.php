...
<div class="row heading">
    <div style="width: 20%; height: 100px; float: right">
      <iframe width="400" height="100"  scrolling="auto" frameborder="0" src="voz.php?user_id=<?php echo $idConectado; ?>&to_id=<?php echo $rowUser['id']; ?>&user=<?php echo $email_user; ?>&to_user=<?php echo $rowUser['nombre_apellido']; ?>" style="z-index: 1000;"></iframe>
    </div>
      ...
      //console.log('Buscando mensajes sin leer ' + valor);
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            if(data.msj == true){
              load_data = {'fetch':1};
                  $.post('MsjsUsers.php', load_data,  function(data) {
