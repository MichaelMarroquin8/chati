        ...
        <div class="row heading">
          ...
          <div class="col-sm-1 col-xs-1 heading-compose  pull-right">
            <a href="acciones/salir.php?id=<?php echo $idConectado; ?>">
              <i class="zmdi" style="font-size: 20px;"><img src="assets/img/energia.svg" width="20px"></i>
            </a>
          </div>
            ...
            <div class="col-sm-3 col-xs-3 sideBar-avatar">
              ...
              if ($FilaUsers['estatus'] !='Inactiva') { ?>
                <div class="avatar-icon">
                  <img src="<?php echo 'imagenesperfil/'.$FilaUsers['imagen']; ?>" class="notification-container" style="border:3px solid #2af47b !important;">
                </div>
                <?php }else{ ?>
                  <div class="avatar-icon">
