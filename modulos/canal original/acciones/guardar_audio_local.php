...
if(move_uploaded_file($rutaAudioSubido, $rutaDeGuardadoLocal)) {
  $leido = "NO";
  $NuevoMsj  = ("INSERT INTO msjs (user,user_id,to_user,to_id,fecha,nombre_equipo_user,leido,archivos) 
  VALUES ('$user', '$user_id', '$to_user', '$to_id', '$FechaMsj', '$nombre_equipo_user', '$leido', '$rutaDeGuardadoBD')");
