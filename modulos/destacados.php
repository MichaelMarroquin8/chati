...
$query = "SELECT * FROM espacios,calificar WHERE espacios.estado='disponible' AND espacios.sitiore='$sitiotw' AND espacios.idcliente=calificar.idcliente
";

if($_POST['query'] != '')
{
  $query .= '
  AND (espacios.nomb LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" OR espacios.palabras LIKE "%'.str_replace(' ', '%', $_POST['query']).'%")
  ';
}

$query .= 'GROUP BY espacios.idcliente ORDER BY espacios.idesp ASC ';
...
?>	
  <tr>
	...
	<img src="imagenes/clic.gif" width="50px"></td>
  </tr>
<?php
}
?>
