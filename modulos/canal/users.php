...
$simular=mysqli_query($con,"select * from `usuarios` where idusuario='$ref' ");
...
$QueryUsers = ("SELECT * FROM usuarios,espacios WHERE usuarios.idusuario!='$idConectado' AND usuarios.idusuario=espacios.idcliente AND espacios.tokenc='$tokenc' ORDER BY usuarios.emailusuario ASC ");
$resultadoQuery = mysqli_query($con, $QueryUsers);
      ...
      <div class="status-bar"></div>
        <div class="row heading">
          ...
          <div class="col-sm-1 col-xs-1  pull-right icohome">
            ...
            <a href="home.php?tokenc=<?php echo $tokenc;?>&ref=<?php echo $ref;?>&nombespac=<?php echo $nombespac;?>">
                  ...
                  <span class="name-meta">
                   <?php
					...
					<br> 
					 ...
					 (<b style="font-size:12px;"><?php echo $nombespac; ?></b>)
...
$(function() {
  ...
  var ruta = "UserSeleccionado.php?tokenc=<?php echo $tokenc?>&ref=<?php echo $ref?>&nombespac=<?php echo $nombespac?>";
