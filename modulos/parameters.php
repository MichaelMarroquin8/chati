...
<script type="text/javascript">
	...
	{
	var respuesta = confirm('Estas seguro que deseas eliminar el sitio?');
...
<br>
<center>
<a href="parameters.php" class="md-oscuro">Sitios</a>
...
<div class="columna">					
                        <h2 class="tm-block-title">Agregar Sitio</h2>


<form action="add/add_sitio.php" method="POST">			
...
<tr>		
	...
	<td><input type="text" id="pais" class="camp" name="pais" autocomplete="off" required /></td>
</tr>
<tr>		
	<td><h6 class="perfil">Nombre del Sitio:</h6></td>	
	<td><input type="text" id="nsitio" class="camp" name="nsitio" autocomplete="off" required /></td>
</tr>
...
<script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"lista_sitios.php?rango=<?php echo $rango?>&usuar=<?php echo $idusuario?>",
        method:"POST",
